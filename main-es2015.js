...
/* harmony import */ var _pyequion_store_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pyequion-store.service */ "./src/app/pyequion-store.service.ts");
...
const mapTypeActivityCalculation = {
    'IDEAL': 0,
    'DEBYE': 1,
    'DEBYE_MEAN': 2,
    'PITZER': 3,
...
let StepperComponent = class StepperComponent {
    constructor(fb, pyequionStore) {
        ...
        // private eqSystemSubject = new BehaviorSubject<EquilibriumModel>(null);
    ...
    ngOnInit() {
        ...
        this.pyequionStore.eqSystem$.subscribe((eqSys) => {
            ...
            const compoundsVals = this.compoundsInput.value;
            if (mapCloseEquationInverse[closeVal] == 'OPEN')
                extraPrmtrCtrl.setValue(pCO2_ref);
            else if (mapCloseEquationInverse[closeVal] == 'PH')
                extraPrmtrCtrl.setValue(7.0);
            else if (mapCloseEquationInverse[closeVal] == 'CARBON_TOTAL') {
    ...
    handleRemoveCompound(i) {
        ...
        // this.compoundsInput.push(this.fb.control('', Validators.required));
...
module.exports = __webpack_require__(/*! /home/caio/Projects/Carbonate/Repositories/pyequion-viewer/src/main.ts */"./src/main.ts");
